 ...
 */
let nameInCapsLowered = nameInCaps.lowercased()
let namelowerd = name.lowercased()
if nameInCapsLowered == namelowerd{
...
let newTextToSearchThrough = textToSearchThrough.lowercased()
if newTextToSearchThrough.contains(textToSearchFor){
    print("i found it")
}
